...
Window_BattleStatus.prototype.drawGaugeAreaWithTp = function(rect, actor) {
    var totalArea = this.gaugeAreaWidth() - 30;
		var hpW = parseInt(totalArea * 112 / 300);
		var otW = parseInt(totalArea * 70 / 300);
		this.drawActorHp(actor, rect.x + 50, rect.y, hpW);
    this.drawActorMp(actor, rect.x + hpW + 65, rect.y, otW);
    this.drawActorTp(actor, rect.x + hpW + otW + 80, rect.y, otW);
};
